...
const Dashboard: React.FC = () => {
    ...
    const completionRate = tasks.length > 0 ? (completedTasks.length / tasks.length * 100).toFixed(2) : '0';
        ...
        <div className="container mx-auto p-4">
            ...
            {currentUser && (
                <div className="mb-6 bg-white p-4 rounded-lg shadow">
                    ...
                    <p className="text-gray-600">
                        {currentUser.role === 'Team Leader' ? 'U have access to team leader panel' : 'Access to your tasks and custom dashboard'}
                    </p>
                </div>
            )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                        ...
                        <div key={task.id} className="mb-3 p-3 border-b">
                            <div className="flex justify-between">
                                ...
                                <span className={`px-2 py-1 rounded-full text-xs ${
                                    ...
                                    : task.status === TaskStatus.IN_PROGRESS ? 'bg-blue-100' 
                                    : 'bg-yellow-100'
                                }`}>
                                    {task.status}
                                </span>
                    ...
                    {tasks.length === 0 && (
                        <p className="text-gray-500">No tasks TODO</p>
                    )}
                </div>
            </div>
        </div>
